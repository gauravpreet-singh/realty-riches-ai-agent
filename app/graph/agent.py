...
def build_graph():
    ...
    for name, fn in [
        ...
        ("persist_buyer_search_result", persist_buyer_search_result),
    ...
    graph.add_conditional_edges(
        ...
        {
            "buyer": "match_properties",
            "both": "extract_seller_requirements",
        },
    )

    graph.add_edge("match_properties", "persist_buyer_search_result")
    graph.add_edge("persist_buyer_search_result", "generate_response")
